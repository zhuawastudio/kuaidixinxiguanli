<template>
    <div style="backgroundImage: url('/kuaidixinxiguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">快递信息管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="快递员姓名" class="input" v-if="tableName=='kuaidiyuan'">
                            <el-input v-model="ruleForm.kuaidiyuanName" autocomplete="off" placeholder="快递员姓名"  />
                        </el-form-item>
                        <el-form-item label="快递员手机号" class="input" v-if="tableName=='kuaidiyuan'">
                            <el-input v-model="ruleForm.kuaidiyuanPhone" autocomplete="off" placeholder="快递员手机号"  />
                        </el-form-item>
                        <el-form-item label="快递员身份证号" class="input" v-if="tableName=='kuaidiyuan'">
                            <el-input v-model="ruleForm.kuaidiyuanIdNumber" autocomplete="off" placeholder="快递员身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='kuaidiyuan'">
                            <el-input v-model="ruleForm.kuaidiyuanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.kuaidiyuanName)&& 'kuaidiyuan'==this.tableName){
                                this.$message.error('快递员姓名不能为空');
                                return
                            }
                             if('kuaidiyuan' == this.tableName && this.ruleForm.kuaidiyuanPhone&&(!this.$validate.isMobile(this.ruleForm.kuaidiyuanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.kuaidiyuanIdNumber)&& 'kuaidiyuan'==this.tableName){
                                this.$message.error('快递员身份证号不能为空');
                                return
                            }
                            if('kuaidiyuan' == this.tableName && this.ruleForm.kuaidiyuanEmail&&(!this.$validate.isEmail(this.ruleForm.kuaidiyuanEmail))){
